...
<div class="contact">
	<div class="container">
		...
		<div class="col-md-3">
			...
			<textarea name="message" rows="15" placeholder="Message" class="form-control" ></textarea>
			<br>
			<input type="submit" name="feed" value="Send" class="btn btn-primary" />
			</form>
			<?php 
			if(isset($_POST['feed']))
			{
				...
				$message=$_POST['message'];
					...
					if(mysql_query("insert into feedback values(DEFAULT,'$usr_id','$sub','$message')"))
					{
