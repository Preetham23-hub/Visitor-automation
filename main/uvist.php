...
<div class="contact">
	<div class="container">
		<h3>Approve Visitor Added by Security</h3>
		
			<div class="col-md-12">
			<?php 
			$log=mysql_query("select * from visitor_arrival where uid='$usr_id' and aby='security' and status='W' ");
			...
			while($row=mysql_fetch_array($log))
			{
				...
				echo "<td>$row[6]</td>";
				echo "<td>$row[7]</td>";
				echo "<td><a href='vstat.php?id=$row[0]&val=NA' ><spam class='glyphicon glyphicon-ok'></spam></a>&nbsp&nbsp&nbsp<a href='vstat.php?id=$row[0]&val=R' ><spam class='glyphicon glyphicon-remove'></spam></a></td>";
