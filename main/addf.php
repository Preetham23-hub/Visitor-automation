...
<div class="contact">
	<div class="container">
		...
		<div class="col-md-3">
			...
			<br>
			<input type="text" name="phone" placeholder="Phone Number" pattern="[7|8|9][0-9]{9}" class="form-control" />
			<br>
			...
			if(isset($_POST['add']))
			{
				...
				$phone=$_POST['phone'];
					...
					if(mysql_query("insert into family values(DEFAULT,'$usr_id','$name','$phone')"))
					{
	...
	echo "<script> window.location.assign('addf.php'); </script>"; 
		...
		<div class="col-md-4">
			...
			<div class="col-md-6">
			<?php 
			$log=mysql_query("select * from family where uid='$usr_id' ");
			...
			while($row=mysql_fetch_array($log))
			{
				...
				echo "<td>$row[2]</td>";
				echo "<td>$row[3]</td>";
				echo "<td><a href='delnum.php?id=$row[0]' ><spam class='glyphicon glyphicon-trash'></spam></a></td>";
