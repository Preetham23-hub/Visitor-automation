...
<div class="contact">
	<div class="container">
		...
		<div class="col-md-3">
			...
			<br>
			<textarea name="message" rows="15" placeholder="Purpose" class="form-control" ></textarea>
			<br>
...
$value = rand($min, $max);
			include("sms.php");
					if(mysql_query("insert into visitor_arrival values(DEFAULT,'$name','$phone','$value','NA','$atime','---','$purp','user', '$usr_id')"))
					{
						echo "<script language='JavaScript' type='text/javascript'>
		alert('Successfully Sent');
		</script>";
	echo "<script> window.location.assign('avis.php'); </script>"; 
					}
					else
					{
						echo "<script language='JavaScript' type='text/javascript'>
