...
<div class="contact">
	<div class="container">
		<h3>Visitors Details Added by <?php echo $usr_name; ?></h3>
		
			<div class="col-md-12">
			<?php 
			$log=mysql_query("select * from visitor_arrival where uid='$usr_id' and aby='user' and status='NA' ");
			...
			while($row=mysql_fetch_array($log))
			{
				...
				echo "<td>$row[6]</td>";
				echo "<td>$row[7]</td>";
				echo "<td><a href='delvis.php?id=$row[0]' ><spam class='glyphicon glyphicon-trash'></spam></a></td>";
				echo "</tr>";
			}
			?>
			</table>
