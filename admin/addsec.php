...
if(isset($_POST['add']))
{
	...
	$phone_check=mysql_query("select * from alert where phone='$phone'  ");
	
	
	
	
	if(mysql_num_rows($phone_check)!=0)
	{
		echo "<script language='JavaScript' type='text/javascript'>
			alert('Already Phone Number Exist...!!!');
			</script>";
			echo "<script> window.location.assign('addsec.php'); </script>";
			exit(0);
			
	}
	
	
		if(mysql_query("insert into alert values(DEFAULT,'$name','$phone')"))
		{
			echo "<script language='JavaScript' type='text/javascript'>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Add Security Details</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                <!-- Page Header -->
                ...
                <!-- Page Body -->
                <div class="page-body">
                <h1 align="center">Add Security Details</h1>
                <br>
                    <div class="row">
                    <div class="col-lg-4">
                    </div>
