   ...
   ?>
           ...
           <!-- /Chat Bar -->
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">
                <h1 align="center"> Security  Details</h1>
                <br>
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption"> Security  Details</span>
                                    ...
                                    <table class="table table-striped table-hover table-bordered" >
									   ...
									   <tr>
										...
										while($a=mysql_fetch_array($sql))
										{
												...
												<td><a href='secdel.php?id=<?php echo $a[0] ?>' ><center><span  class="glyphicon glyphicon-trash"></span></center></a></td>
                                            </tr>
												<?php
