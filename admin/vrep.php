...
<body>
   ...
   ?>
           ...
           <!-- /Chat Bar -->
            ...
            <div class="page-content">
                ...
                <br>
                    ...
                    <input type="date" class="form-control" name="fdate" placeholder="Name" required /><br>
					
					<input type="date" class="form-control" name="tdate" placeholder="Phone"  required /><br>
					...
					<br />
					  ...
					  <div class="row">
                                                        <div class="col-sm-2 ">
                                                            <button type="submit" name="add" class="btn btn-palegreen">Check</button>
                                                        </div>
                                                        <div class="col-sm-2 ">
	...
	$tdate=$_POST['tdate'];
		...
		$log=mysql_query("select * from visitor_arrival where SUBSTR(atime, 1, 10) >= '$fdate' and SUBSTR(etime, 1, 10) <= '$tdate' and status='A' ORDER by atime");
						?>
