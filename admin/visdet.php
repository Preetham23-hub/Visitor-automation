...
include("session.php");
$id=$_GET['id'];
	$log=mysql_query("select * from visitor_arrival where uid='$id' and status='A' ");
?>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"> Visitors Details</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                <!-- Page Header -->
                ...
                <!-- Page Body -->
                <div class="page-body">
                <h1 align="center"> Visitors Details</h1>
                <br>
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption"> Visitors Details</span>
