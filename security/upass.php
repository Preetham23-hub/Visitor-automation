...
if(isset($_POST['add']))
{
	...
	$acheck=mysql_query("select * from sec_admin where pass='$opass'");

	
	if(mysql_num_rows($acheck)!=0)
	{
				if(mysql_query("UPDATE `sec_admin` SET `pass`='$npass' WHERE `pass`='$opass'"))
					{
            ...
            <div class="page-content">
                ...
                <br>
                    ...
                    <div class="col-lg-4">
                     ...
                     <div class="col-lg-4">
                    <form method="post">
                    <input type="text" class="form-control" placeholder="Old Password" name="opass" required /><br>
                    <input type="text" class="form-control" name="npass" placeholder=" New Password" required /><br>
             
                    
					  <div class="row">
                                                        <div class="col-sm-2 ">
                                                            <button type="submit" name="add" class="btn btn-palegreen">Update</button>
                                                        </div>
                                                        <div class="col-sm-2 ">
