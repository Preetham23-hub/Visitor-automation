<?php
include("session.php");
$sql=mysql_query("Select * from visitor_arrival where aby='security' and status='NA'");
?>
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption"> Visitor  Details</span>
                                    ...
                                    <table class="table table-striped table-hover table-bordered" >
									   ...
									   <tr>
										...
										while($a=mysql_fetch_array($sql))
										{
												...
												<?php
												echo "<td><a href='vupd.php?id=$a[0]&v=a' ><spam class='glyphicon glyphicon-circle-arrow-up'></spam></a>&nbsp&nbsp&nbsp<a href='vupd.php?id=$a[0]&v=r' ><spam class='glyphicon glyphicon-circle-arrow-down'></spam></a></td>";
												?>
                                            </tr>
												<?php
