<?php
include("session.php");
$sql=mysql_query("Select * from visitor_arrival where aby='user' and status='NA'");
?>
                                    ...
                                    <table class="table table-striped table-hover table-bordered" >
									   ...
									   <tr>
										...
										while($a=mysql_fetch_array($sql))
										{
												...
												<?php
												echo "<td><a href='vupd1.php?id=$a[0]&v=a' ><spam class='glyphicon glyphicon-circle-arrow-up'></spam></a>&nbsp&nbsp&nbsp<a href='vupd2.php?id=$a[0]&v=r' ><spam class='glyphicon glyphicon-circle-arrow-down'></spam></a></td>";
												?>
                                            </tr>
												<?php
