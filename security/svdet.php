<?php
include("session.php");
$sql=mysql_query("Select * from owner_personal");
?>
...
<head>
    <meta charset="utf-8" />
    <title> Owner Personal Owners Personal Details</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"> Owners Personal  Details</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                <!-- Page Header -->
                ...
                <!-- Page Body -->
                <div class="page-body">
                <h1 align="center"> Owners Personal  Details</h1>
                <br>
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption"> Owners Personal  Details</span>
                                ...
                                <div class="widget-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" >
									   ...
									   <tr>
												...
												<th><center>Adhar No.</center></th>
												<th><center>Apart No.</center></th>
												<th><center>Block No.</center></th>
												<th><center>Family</center></th>
												<th><center>Visitors</center></th>
										...
										while($a=mysql_fetch_array($sql))
										{
                                                ...
                                                <td align='center'><?php echo $a[4] ?></td>
												
												<td align='center'><?php echo $a[5] ?></td>
												<td align='center'><?php echo $a[6] ?></td>
												<td align='center'><?php echo $a[7] ?></td>
												<td><a href='famdet.php?id=<?php echo $a[0] ?>' ><center><span  class="glyphicon glyphicon-check"></span></center></a></td>
												<td><a href='visdet.php?id=<?php echo $a[0] ?>' ><center><span  class="glyphicon glyphicon-check"></span></center></a></td>
												<td><a href='opdel.php?id=<?php echo $a[0] ?>' ><center><span  class="glyphicon glyphicon-trash"></span></center></a></td>
                                            </tr>
												<?php
