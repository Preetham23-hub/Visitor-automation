...
if(isset($_POST['add']))
{
	...
	$check=mysql_query("select * from owner_personal where apart='$apart' and block='$block' ");
	...
	if(mysql_num_rows($check)==0)
	{
		echo "<script language='JavaScript' type='text/javascript'>
			...
			echo "<script> window.location.assign('addv.php'); </script>";
			exit(0);
	}
	
	
	$o_det=mysql_fetch_array($check);
	
	$uid=$o_det[0];
	$o_phone=$o_det[3];
	
		if(mysql_query("insert into visitor_arrival values(DEFAULT,'$name','$phone','---','W','---','---','$purp','security','$uid')"))
		{
			include("sms.php");
			echo "<script language='JavaScript' type='text/javascript'>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Add Visitor Request</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                <!-- Page Header -->
                ...
                <!-- Page Body -->
                <div class="page-body">
                <h1 align="center">Add Visitor Request</h1>
                <br>
                    <div class="row">
                    <div class="col-lg-4">
                    </div>
					...
					<br />
                    <textarea class="form-control" name='purp'></textarea>
					<br>
                  
                   
					  <div class="row">
                                                        <div class="col-sm-2 ">
                                                            <button type="submit" name="add" class="btn btn-palegreen">Place </button>
                                                        </div>
                                                        <div class="col-sm-2 ">
